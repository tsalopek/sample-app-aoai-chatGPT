...
if __name__ == "__main__": 
    ...
    parser.add_argument("--embedding-model-endpoint", type=str, help="Endpoint for the embedding model to use for vector search. Format: 'https://<AOAI resource name>.openai.azure.us/openai/deployments/<embedding deployment name>/embeddings?api-version=2023-03-15-preview'")
