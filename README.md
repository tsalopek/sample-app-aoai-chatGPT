...
|UI_LOGO|No|| Logo (left-top). Defaults to the Andworx logo. Configure the URL to your logo image to modify.
|UI_CHAT_LOGO|No|| Logo (chat window). Defaults to the Andworx logo. Configure the URL to your logo image to modify.
